/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 8b473c31ed3ac6567408cafdb9fabe9a)
// Runtime types generated with workerd@1.20260701.1 2026-06-21 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	WECHAT_MINI_APP_ID: "wx02ce91659b1acef4";
	BGM_API_URL: string;
	SITE_URL: string;
	EASY_AUTH_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WECHAT_MINI_APP_ID" | "BGM_API_URL" | "SITE_URL" | "EASY_AUTH_URL" | "EASY_AUTH_CLIENT_ID" | "EASY_AUTH_CLIENT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_TOKEN" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
